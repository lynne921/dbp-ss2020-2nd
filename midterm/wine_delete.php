<?php
    ...
    $query = "
        SELECT * FROM wine_all  WHERE field_0='{$filtered_id}' ";    
...
<h2><a href="index.php">와인 리뷰</a> | 와인 리뷰 등록</h2>
    <form action="wine_delete_process.php" method="POST">
    <label>리뷰 번호:</label>
        <input type="text" name="field_0" value="<?=$row['field_0']?>" placeholder="field_0"><br>
        <label>와인 생산지:</label>
